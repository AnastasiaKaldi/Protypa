...
-- 1. Mark profile complete + grant admin so you can access /admin too
update profiles
...
-- 3. Four διαγωνίσματα. First three are unlocked + closed (gradable), fourth is in the future.
...
values
  ...
  ('a1111111-0000-0000-0000-000000000004', 4, 'Διαγώνισμα 4 — Ιούνιος 2026',   'bundle',
   '2026-06-15', '2026-12-15T09:00:00Z', null, 20, 20, true)
on conflict (id) do update set
...
--   • Dashboard: 6 students, μ.ο. ~85, 4 διαγωνίσματα
--   • /account/students: 6 students grouped by Γυμνάσιο / Λύκειο
--   • /account/students/<id>: real charts (line chart, donut, weakness bars)
--   • /account/grading: 3 submitted + 1 future
--   • Submit-able διαγώνισμα available: Sim 2 (still open) — re-grade if you want
-- ──────────────────────────────────────────────────────────────────────────

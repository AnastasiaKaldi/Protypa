        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <div className="space-y-10 text-ink/80 text-sm leading-relaxed">
            ...
            <Block num="01" title="Γενικά">
              Η Protupa (protupa.gr) σέβεται το απόρρητό σας και δεσμεύεται να προστατεύει τα προσωπικά σας δεδομένα σύμφωνα με τον Γενικό Κανονισμό Προστασίας Δεδομένων (GDPR — Κανονισμός ΕΕ 2016/679).
            </Block>

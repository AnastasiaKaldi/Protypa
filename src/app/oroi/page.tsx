        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <div className="space-y-10 text-ink/80 text-sm leading-relaxed">
            ...
            <Block num="02" title="Περιγραφή υπηρεσίας">
              Η Protypa παρέχει ψηφιακά εργαλεία προετοιμασίας για εξετάσεις Πρότυπων, Ωνάσειων και Εκκλησιαστικών Σχολείων. Η πρόσβαση στο περιεχόμενο παρέχεται μετά από εφάπαξ πληρωμή για καθορισμένο χρονικό διάστημα.
            </Block>
            ...
            <Block num="05" title="Πνευματική ιδιοκτησία">
              Όλο το περιεχόμενο της πλατφόρμας (θέματα, απαντήσεις, λογισμικό, γραφικά) αποτελεί πνευματική ιδιοκτησία της Protypa. Απαγορεύεται αυστηρώς η αναπαραγωγή, διανομή ή εμπορική εκμετάλλευσή του χωρίς γραπτή άδεια.
            </Block>
